...
import { FlaskConical, RefreshCw, Volume2, VolumeX, BookOpen } from 'lucide-react';

// ---------------------------------------------------------
// COMPONENT: Header
// ---------------------------------------------------------
const Header = ({ audioEnabled, setAudioEnabled, setShowResetModal, onOpenRecipeLog }) => (
  <header className="w-full max-w-5xl flex justify-between items-center mb-8 pb-4 border-b border-slate-800 relative z-10">
    ...
    <div className="flex items-center gap-4">
      {/* NEW: Recipe Log Button */}
      <button 
        onClick={onOpenRecipeLog} 
